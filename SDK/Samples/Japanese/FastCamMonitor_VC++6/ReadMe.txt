========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : FastCamMonitor
========================================================================


AppWizard が生成した FastCamMonitor には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには FastCamMonitor を構成している各ファイルの概要説明が含まれています。
...
FastCamMonitor.h
    ...
    みます） をインクルードし、また CFastCamMonitorApp アプリケーションクラスを宣
    言します。

FastCamMonitor.cpp
    このファイルは CFastCamMonitorApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\FastCamMonitor.ico
    ...
    ルです。このアイコンはリソース ファイル FastCamMonitor.rc によってインクルード
    されます。
...
FastCamMonitorDlg.h, FastCamMonitorDlg.cpp - ダイアログ
    これらのファイルは CFastCamMonitorDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な FastCamMonitor.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) FastCamMonitor.pch 
