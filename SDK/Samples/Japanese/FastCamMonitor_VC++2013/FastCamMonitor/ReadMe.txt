================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: FastCamMonitor プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した FastCamMonitor には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには FastCamMonitor アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
FastCamMonitor.h
   ...
   CFastCamMonitorApp アプリケーション クラスを宣言します。

FastCamMonitor.cpp
   これは、アプリケーション クラス CFastCamMonitorApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\FastCamMonitor.ico
   ...
   アイコンはメイン リソース ファイル FastCamMonitor.rc に含まれていま
   す。
...
FastCamMonitorDlg.h, FastCamMonitorDlg.cpp - ダイアログ
   これらのファイルは CFastCamMonitorDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な FastCamMonitor.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   FastCamMonitor.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
