// FastCamMonitor.cpp : Defines the class behaviors for the application.
//
...
// CFastCamMonitorApp construction
...
// The one and only CFastCamMonitorApp object

CFastCamMonitorApp theApp;


// CFastCamMonitorApp initialization
