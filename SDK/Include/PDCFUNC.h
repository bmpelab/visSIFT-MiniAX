...
unsigned long WINAPI PDC_GetDelayTypeList(
	unsigned long	nDeviceNo,
	unsigned long	*pSize,
	unsigned long	*pList,
	unsigned long	*pErrorCode
...
* for SHADING
*/
unsigned long WINAPI PDC_GetShadingResponseType(
	unsigned long nDeviceNo,
	unsigned long nChildNo,
	unsigned long *pResponseType,
	unsigned long *pErrorCode);

unsigned long WINAPI PDC_GetLiveImageIRIGData(
	unsigned long nDeviceNo,
	unsigned long nChildNo,
	PPDC_IRIG_INFO pData,
	unsigned long *pErrorCode);

unsigned long WINAPI PDC_GetMechanicalShutterError(
	unsigned long nDeviceNo,
...
* for CFast
*/
unsigned long WINAPI PCFC_GetValidDrives(unsigned long* pDrives, unsigned long* pErrorCode);
unsigned long WINAPI PCFC_OpenDrive(unsigned long nDriveNo, unsigned long* pNumOfData, unsigned long* pErrorCode);
unsigned long WINAPI PCFC_CloseDrive(unsigned long* pErrorCode);
unsigned long WINAPI PCFC_GetRecordInfo(unsigned long nDataNo, PDC_RECORD_INFO* pRecordInfo, unsigned long* pErrorCode);
unsigned long WINAPI PCFC_GetExposeTimeData(unsigned long nDataNo, unsigned long* pExposeTimeData, unsigned long* pErrorCode);
unsigned long WINAPI PCFC_GetImageData(unsigned long nDataNo, long nFrameNo, long nInterleave, void* pImageData, unsigned long* pErrorCode);
